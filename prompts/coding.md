...
Tool names are exact and case-sensitive; treat `/.aidd/tools.md` as canonical before using any tool names (read legacy `.autok/tools.md` only when migrating older projects).
